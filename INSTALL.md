...
6. Enter a normal Trainer battle. Confirm `CALL` replaces `RUN`.
...
8. Use Shadow Rush until Hyper Mode starts. Confirm the attempted Shadow Rush
   loses that turn, then test a recovered normal move for possible
   disobedience.
...
11. Try Rare Candy, Thunder Stone, a TM/HM, move reordering with SELECT, and a
...
- **No Poké Ball:** talk to the Researcher again.
